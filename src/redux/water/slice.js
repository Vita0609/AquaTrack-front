        ...
        builder
            ...
            .addCase(addWater.fulfilled, (state, action) => {
                ...
                if (monthlyRecordIndex !== -1) {
                    ...
                    state.waterMonthly.data[monthlyRecordIndex].percentage =
                        roundToTwoDecimals(
                            state.waterMonthly.data[monthlyRecordIndex]
                                .percentage + newRecord.percentage
                        );
                }
            })
            .addCase(addWater.rejected, (state) => {
                state.waterDaily.errorMessage =
            ...
            .addCase(updateWaterIntakeRecord.fulfilled, (state, action) => {
                ...
                if (dailyIndex !== -1) {
                    ...
                    state.waterDaily.percentage =
                        roundToTwoDecimals(totalPercentage);
                    ...
                    if (monthlyIndex !== -1) {
                        ...
                        state.waterMonthly.data[monthlyIndex].percentage =
                            roundToTwoDecimals(
                                state.waterMonthly.data[monthlyIndex]
                                    .percentage +
            ...
            .addCase(deleteWaterIntakeRecord.fulfilled, (state, action) => {
                ...
                if (dailyIndex !== -1) {
                    const [removedRecord] = state.waterDaily.data.splice(
                        dailyIndex,
                        1
                    );
